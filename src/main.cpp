...
bool CheckTransactionWithoutProofVerification(const CTransaction& tx, CValidationState &state)
{
     ...
     *    When fOverwintered is set, and Overwinter network upgrade has activated,
     *    this function checks that tx.nVersion avoids the the following ranges:
    ...
    if (tx.fOverwintered) {
        ...
        else if (tx.nVersion > OVERWINTER_MAX_TX_VERSION ) {
